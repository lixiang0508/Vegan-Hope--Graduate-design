...
class Address extends PureComponent{
    ...
    getData(){
        axios.get(`http://localhost:8085/shipping/findAddrs`,{
            headers:{
    ...
    addNew=(province,city,address,zip,receiverName,phone)=>{
        axios.post(`http://localhost:8085/shipping/add`,{
            headers:{
                'token':localStorage.getItem('user_token')
            },
    ...
    //删除
    deleteAddr=(id)=>{
        axios.post(`http://localhost:8085/shipping/delete/`+id,{
            headers:{
                'token':localStorage.getItem('user_token')
            }
    ...
    changeAddr=(id,province,city,address,zip,phone,receiverName)=>{
        axios.post(`http://localhost:8085/shipping/change`,{
            headers:{
                'token':localStorage.getItem('user_token')
            },
            id:id,
